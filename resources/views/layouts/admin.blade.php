...
<head>
    ...
    <title>@yield('titulo', 'Panel de administración — SS Shop')</title>
...
<body>
    <div class="d-flex">
        <aside class="barra-admin p-3">
            <a href="{{ route('admin.inicio') }}" class="marca d-block mb-4">SS SHOP · ADMIN</a>

            <nav class="d-flex flex-column gap-1">
                <a href="{{ route('admin.inicio') }}" class="{{ request()->routeIs('admin.inicio') ? 'activo' : '' }}">Resumen</a>
                <a href="{{ route('admin.productos.index') }}" class="{{ request()->routeIs('admin.productos.*') ? 'activo' : '' }}">Productos</a>
                <a href="{{ route('admin.categorias.index') }}" class="{{ request()->routeIs('admin.categorias.*') ? 'activo' : '' }}">Categorías</a>
                <a href="{{ route('admin.stock.index') }}" class="{{ request()->routeIs('admin.stock.*') ? 'activo' : '' }}">Control de stock</a>

                <hr style="border-color: rgba(255,255,255,0.1);">

                <a href="{{ route('inicio') }}">Ver tienda pública</a>
